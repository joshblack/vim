...
function! joshblack#autocomplete#setup_mappings() abort
  ...
  execute 'inoremap <buffer> <silent> ' . g:UltiSnipsJumpForwardTrigger .
        \ ' <C-R>=joshblack#autocomplete#expand_or_jump("N")<CR>'
  execute 'snoremap <buffer> <silent> ' . g:UltiSnipsJumpForwardTrigger .
        \ ' <Esc>:call joshblack#autocomplete#expand_or_jump("N")<CR>'
  execute 'inoremap <buffer> <silent> ' . g:UltiSnipsJumpBackwardTrigger .
        \ ' <C-R>=joshblack#autocomplete#expand_or_jump("P")<CR>'
  execute 'snoremap <buffer> <silent> ' . g:UltiSnipsJumpBackwardTrigger .
        \ ' <Esc>:call joshblack#autocomplete#expand_or_jump("P")<CR>'
...
function! joshblack#autocomplete#teardown_mappings() abort
...
function! joshblack#autocomplete#expand_or_jump(direction) abort
...
function! joshblack#autocomplete#deoplete_init() abort
